...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiaGFkbmd1eWVuIiwiYSI6ImNsM2JlbHR3ODAwNmMza280anJrcDBnM3UifQ.UcZ-yCM7TcTw_gz_gWjSQw';
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 40
    }).setLngLat(loc.coordinates).setHTML(loc.description).addTo(map); // Extend map bounds to include current location
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? 'http://127.0.0.1:3000/api/v1/users/updatePassword' : 'http://127.0.0.1:3000/api/v1/users/updateInfor';
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
...
var stripe = Stripe('pk_test_51L5Pn1CDadMRNO6O5m5SNjXVFhRiRa3va4i0sfUQLPFwh6kBMciqTbMhDmVrHII8y53VhOnlu54fEcs4CeCw146W00b0bIP2zM');
